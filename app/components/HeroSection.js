  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Discover the professors who match your learning style and academic goals, with ProfSpective’s personalized recommendations and student insights.
        </Typography>
        <Box
          sx={{
            display: "flex",
      ...
      <Box
          sx={{
            position: "relative",
            width: "420px",
            height: "420px", // Set a fixed height for the image container
            maxWidth: "420px", // Set a max width for the image container
          }}
        >
          <Image
            src="/ProfspectiveHero.png" // Update this path to your image file
            alt="ProfSpective"
